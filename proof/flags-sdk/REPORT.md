...
| live-rollout | A management SDK change reaches the running consumer without restart | PASS | revision=2, latency=15.1ms |
| live-rollout | Live delivery completes in under one second | PASS | 15.1ms |
